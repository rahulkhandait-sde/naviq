      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-black/40 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition-all duration-500">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Sign in to your NaviQ account</p>
          ...
          <div className="mt-8 text-center space-y-4">
            ...
            <div className="text-gray-500 text-sm">
              ...
              <Link to={"/signup"} className="text-blue-400 hover:text-blue-300 transition-colors duration-300 font-medium">Sign up here</Link>
